...
import { deleteScenario } from "../../redux/scenariosSlice";
    ...
    <div className="page_wrapper">
      ...
      <div className="scenarios_page_header">
        ...
        <div className="scenarios_options">
          <Button title="New Scenario" bgColor="#489BBC" textColor="white" />
          <Button title="Add Vehicle" bgColor="#5EB75C" textColor="white" />
